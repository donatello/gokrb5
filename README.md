...
[![GoDoc](https://godoc.org/github.com/minio/gokrb5.v7?status.svg)](https://godoc.org/github.com/minio/gokrb5.v7) [![Go Report Card](https://goreportcard.com/badge/github.com/minio/gokrb5.v7)](https://goreportcard.com/report/github.com/minio/gokrb5.v7) [![Build Status](https://travis-ci.org/jcmturner/gokrb5.svg?branch=master)](https://travis-ci.org/jcmturner/gokrb5)
...
```
go get -d github.com/minio/gokrb5.v7/...
```
To import this package, add the following line to your code:
```go
import "github.com/minio/gokrb5.v7/<sub package>"
```
...
```go
import "github.com/minio/gokrb5.v7/config"
...
```go
import 	"github.com/minio/gokrb5.v7/keytab"
...
```go
import 	"github.com/minio/gokrb5.v7/client"
...
```go
import 	"github.com/minio/gokrb5.v7/service"
